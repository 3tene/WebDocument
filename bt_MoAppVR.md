## VRモードの使い方 (モーションアプリ連携)

>HTC Vive や Oculus Rift を使用してアバターを操作します。  
>\
>対応しているVR機器については[対応機器](equipment.html)を参照してください。  
>\
>[モーションアプリのダウンロードの仕方](download3tene.html)
...
>[VRモードの使い方](../V2/index.html#UsingVR.html)  
>\
>モーションアプリ(VR)の動作確認後に 3tene と連携接続を行って使用します。  
>[モーションアプリ連携について](bt_MotionApp.html)
