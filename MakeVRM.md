...
>こちらの[VRoidStudio で作成した VRM を改良する！](MakeVRM_2.html)を試してみてください。  
>\
...
>### 口を閉じたバージョンの表情を作ろう！
>
>3tene 拡張に対応した[口が閉じたバージョンの表情を作ろう！](MakeVRM_3.html)  
>\
>※[iPhone フェイストラッキングの自動表情連携](ft_iphone_expression.html)にも使えます。
...
>[アニメまゆ毛の作り方](UCTShader.html)を参照してください。  
>\
...
>[窓の杜 Blender 関連記事（VRM のカスタム等）](MakeVRM_4.html)
