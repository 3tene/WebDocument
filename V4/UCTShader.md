...
>![画像](image/UCTShader_1.png "")

>Face を選択すると Inspector（画面右側）に詳細が表示されます。

>![画像](image/UCTShader_2.png "")
